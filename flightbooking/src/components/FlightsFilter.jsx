...
export default function FlightsFilter({flights}) {
    ...
    //get unique type
    let types = getUnique(flights,'type');
    //get all
    types = ['all',...types];
    ...
    let people = getUnique(flights,'capacity');
        ...
        <div className="container mt-5">
            ...
            <div className="row">
                <div className="col-md-6 col-12">
                    ...
                    <div className="form-group">
                        <label htmlFor="capacity">Customers</label>
                        <select name="capacity" id="capacity" value={capacity} className="form-control" onChange={handleChange}>
                            {people}
                        </select>
                    </div>
                    <div className="form-group">
                        <label htmlFor="price">Flight Price ${price}</label>
                ...
                <div className="col-md-4 col-12 ml-auto">
                    ...
                    <div className="input-group my-5">
                        <label htmlFor="size" className="mr-3">Flight Size </label>
