...
import defaultBcg from '../images/flight-2.jpeg';
export default class Booknow extends Component {
    ...
    if(!flight){
        ...
        const {name,capacity,size,price,breakfast,pets,images} = flight;
                ...
                <div className="col-md-10 mx-auto col-12 card shadow-lg border-0 p-4">
                    ...
                    <div className="row">
                        <div className="col-md-6 col-12 my-auto">
                            <img src={mainImg || defaultBcg} className="img-fluid" alt="selected flight" />
                        </div>
                        <div className="col-md-6 col-12 my-auto">
                    ...
                    <div className="row">
                        <div className="col-md-6 col-12">
                            <h6 className="font-weight-bolder">Number of Hours : {daysLeft}</h6>
                            <mark>Please make sure Checkin time is from 9 am to 12 pm</mark>
                        </div>
                        <div className="col-md-6 col-12">
                            <h6 className="font-weight-bold">Price per ride : <span className="badge badge-info">${price}</span></h6>
                ...
                <div className="modal-dialog modal-dialog-centered">
                    <div className="modal-content">
                        <div className="modal-body p-4">
                            <h3>Thank you </h3>
                            <p className="lead">Your Flight is booked successfully....</p>
                        </div>
